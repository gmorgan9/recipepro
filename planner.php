...
<body>
    ...
    <nav class="mobile-bottom-nav">
            ...
            <ul class="list d-flex justify-content-between">
                ...
                <li><a class="d-flex flex-column text-white align-items-center" style="text-decoration: none; font-size: 20px;" href="setting.php"><i class="bi bi-gear-fill" style="margin-bottom: -5px;"></i><span style="font-size: 12px;">Settings</span></a></li>
            </ul>
        </nav>
